// Source: https://github.com/adonisjs/lucid/blob/develop/src/seeders/runner.ts
...
import type { SeederConstructorContract, SeederFileNode } from '@adonisjs/lucid/types/seeder'
import type {
  FileNode,
  QueryClientContract,
  SharedConfigNode,
